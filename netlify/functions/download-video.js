// Netlify Function: Download Video Analysis (JavaScript)
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          message: 'Video analyzed successfully! Use the provided command to download.',
          command: command,
          formatSelector: formatSelector,
          audioGuarantee: audioGuarantee,
          note: 'Copy the command and run it in your terminal to download the video with guaranteed audio.'
        }
      }),
    };
